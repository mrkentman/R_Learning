...
2 - [Vigenere Cipher](https://en.wikipedia.org/wiki/Vigen%C3%A8re_cipher): A type of polyalphabetic substitution, where each letter of the message is assigned a letter from a keyword, and shifted based on the letter assigned. 
